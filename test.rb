...
class WeatherReportTest < Minitest::Test
  ...
  def test_weather_type_01
    assert_equal "Overcast", CurrentConditions.new(zip: 27701).type
  end

  def test_current_temp_in_fahrenheit_02
    assert_equal "71.9 F (22.2 C)", CurrentConditions.new(zip: 27701).temperature
  end

  def test_get_feels_like_temp_03
    assert_equal "71.9 F (22.2 C)", CurrentConditions.new(zip: 27701).feels_like_temp
  end

  def test_get_wind_speed_and_direction_04
    assert_equal "0.0 MPH NW", CurrentConditions.new(zip: 27701).wind_speed
  end

  def test_get_dewpoint_05
    assert_equal "69 F (20 C)", CurrentConditions.new(zip: 27701).dewpoint
  end

  def test_get_humidity_06
    assert_equal "90%", CurrentConditions.new(zip: 27701).humidity
  end
  ...
  #   Current wind speed is: 0.0 MPH NW", CurrentConditions.new(zip: 27701).get_it_all_pretty
  # end
